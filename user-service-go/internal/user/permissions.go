...
func employeePermissions(role string) []string {
	switch role {
	case "ADMIN":
		return []string{"BANKING_BASIC", "CLIENT_MANAGE", "SECURITIES_TRADE_LIMITED", "SECURITIES_TRADE_UNLIMITED", "TRADE_UNLIMITED", "OTC_TRADE", "FUND_AGENT_MANAGE", "EMPLOYEE_MANAGE_ALL"}
	case "SUPERVISOR":
