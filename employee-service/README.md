...
```markdown
# Banka 2025 - Employee Service (Upravljanje zaposlenima)
...
1. U terminalu (u root-u projekta) pokrenite **samo bazu**:
   ...
   ```
2. U IntelliJ-u, pokrenite aplikaciju pritiskom na zeleno **Play** dugme (klasa `EmployeeServiceApplication`).
...
* Gledanje logova servisa: `docker compose logs -f employee-service`
