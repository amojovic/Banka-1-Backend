...
/**
 * WP-13: unit tests for {@link RecurringOrderScheduler}.
 *
 * <p>Plain Mockito — the scheduler is a thin orchestrator that loads the due standing
 * orders and dispatches each by id to {@link RecurringOrderService#runDueOrder(Long)}.
 */
