...
public class Order {
     ...
     * Set once by Hibernate on insert and never updated thereafter; legacy rows
     * predating this column are backfilled from {@code lastModification} by the
     * Liquibase changeset and may otherwise be null.
     */
    @CreationTimestamp
