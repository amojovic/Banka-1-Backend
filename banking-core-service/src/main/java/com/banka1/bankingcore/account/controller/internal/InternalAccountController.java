...
public class InternalAccountController {
     ...
     *
     * <p>Bez {@code @PreAuthorize} — namerno, dosledno sa {@link #defaultAccount}:
     * ceo {@code /accounts/internal/**} prefiks je u {@code permit-all}, pa taj
     * security chain ne parsira JWT; {@code hasRole(...)} provera bi ovde uvek
     * vracala {@code 403}. Pristup je ogranicen path-prefix scope-om.
     *
